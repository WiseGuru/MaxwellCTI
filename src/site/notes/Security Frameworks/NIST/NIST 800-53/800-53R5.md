...
> **NOTE**: If this is your first time looking at the 800-53, please go to [[Security Frameworks/NIST/NIST Frameworks and SPs Overview\|NIST Frameworks and SPs Overview]] first to get a better understanding of 800-53 among the other NIST publications and frameworks.
> *You probably want to start with the [[Security Frameworks/NIST/NIST CSF/NIST CSF\|NIST CSF]].*
### What is it?
...
5. **What are [[Security Frameworks/NIST/NIST 800-53/800-53A\|800-53A]] and [[Security Frameworks/NIST/NIST 800-53/800-53B\|800-53B]]?**
...
### Notes from the official NIST 800-53 Course
...
2. Purpose of the *800-53*
	...
	2. Supports the [[Security Frameworks/NIST/NIST SP 800-37\|RMF]] "Select" and "Implement" steps
...
3. How to read controls
	...
	3. *Organization-Defined Parameters* (*ODP*)
		1. Identifies *Assignments* and *Selections* to customize the control to the organization in *assignment operations*^[[assignment operation - Glossary | CSRC](https://csrc.nist.gov/glossary/term/assignment_operation)]
			1. Additional details on tailoring and applying ODP values is found in [[Security Frameworks/NIST/NIST 800-53/800-53B\|800-53B]]
...
4. Control Families
	1. 20 control families
		1. [[Security Frameworks/NIST/NIST 800-53/FIPS 200\|FIPS 200]] identified 17 security-related areas that led to the original control families
...
6. Updates and supporting documents
	1. Control Catalog Updates can be found at the [RMF project site](https://nist.gov/rmf)
	2. Controls can also be found at the [Cybersecurity and Privacy Reference Tools](https://csrc.nist.gov/projects/cprt/catalog#/cprt/home)
#### Control Families Review
I think what would be most helpful here is to briefly summarize the objective of each control family, identify its [[Security Frameworks/NIST/NIST 800-53/FIPS 200\|FIPS 200]] requirement where applicable, and include any links to sample references. Any more than that, and you might as well just read the dictionary.




[NIST SP 800-53 Introductory Course](https://csrc.nist.gov/csrc/media/Projects/risk-management/images-media/rmf-training/53-intro-course-v1/index.html) - Paused on slide 15/42
