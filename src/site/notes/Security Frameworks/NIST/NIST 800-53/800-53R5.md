...
> **NOTE**: If this is your first time looking at the 800-53, please go to [[Security Frameworks/NIST/NIST 800-53/NIST Frameworks and SPs Overview\|NIST Frameworks and SPs Overview]] first to get a better understanding of 800-53 among the other NIST publications and frameworks.
> *You probably want to start with the [[Security Frameworks/NIST/NIST 800-53/NIST CSF\|NIST CSF]].*
### What is it?
...
5. **What are 800-53A and 800-53B?**
	...
	2. *800-53A* is basically a guide on conducting *Risk Assessments*.
