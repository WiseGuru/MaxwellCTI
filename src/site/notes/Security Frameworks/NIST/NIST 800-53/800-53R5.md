...
3. How to read controls
	1. *Control Identifier*
		...
		2. e.g., *AC-2(3)* specifies the *Access Control* family, the *2nd* control (Account Management), and the *3rd* control enhancement (Disable Accounts)
	2. *Base Control*
	...
	3. *Organization-Defined Parameters* (*ODP*)
		...
		3. *Selections* offer organizations a choice between different control mods according to their needs
			1. e.g., AC-2(7)(a) has organizations choose between a role- or attribute-based privileged account access scheme
...
4. [NIST SP 800-53 Introductory Course](https://csrc.nist.gov/csrc/media/Projects/risk-management/images-media/rmf-training/53-intro-course-v1/index.html) - Paused on slide 13/42
